const cards = [
  { title: 'Runway Status', content: 'Runway 05/23 is open with light crosswind.' },
  { title: 'Club Notices', content: 'Safety briefing at 18:15 in the main hall.' },
  { title: 'Visitor Info', content: 'Parking available on the west apron.' }
]
...
export default function RightInfoPanel(): JSX.Element {
  return (
    <div className="rounded-3xl border border-slate-700 bg-slate-950/80 p-5 shadow-xl shadow-slate-950/20">
      <div className="mb-6 text-lg font-semibold text-white">Right Panel</div>
