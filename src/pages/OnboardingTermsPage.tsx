    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-gradient-to-b from-page-from via-page-via to-page-to px-4 text-slate-100">
        <div className="w-full max-w-md rounded-2xl border border-border bg-panel p-8 text-center shadow-xl shadow-slate-950/20">
          ...
          <p className="mb-4 text-base text-muted-400">Dashboard access requires accepting these terms.</p>
          ...
          <a href="mailto:support@airfieldcentral.com" className="text-base font-semibold text-accent-sky-400 hover:text-accent-sky-500">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-page-from via-page-via to-page-to px-6 py-10 text-slate-100">
      <div className="mx-auto max-w-5xl">
        ...
        <p className="mb-8 text-base text-muted-400">
          A quick orientation, then please read and agree to the Terms & Conditions and Privacy Policy below.
        </p>

        {content.videos.length > 0 && (
          <section className="mb-8">
            <div className="mb-3 text-base font-bold uppercase tracking-widest text-accent-sky-400">Getting started</div>
              ...
              {content.videos.map((video) => (
                <div key={video.id} className="flex aspect-video flex-col items-center justify-center rounded-xl border border-border bg-panel p-3 text-center">
                  {video.url ? (
                    ...
                    <>
                      <div className="mb-1 text-sm font-semibold uppercase tracking-wide text-muted-400">{video.title}</div>
                      <div className="text-sm text-muted-500">Video not yet configured</div>
                    </>
                  )}
                </div>
              ))}
        ...
        <section className="mb-6 rounded-2xl border border-border bg-panel p-6">
          <div className="mb-1 text-base font-bold uppercase tracking-widest text-accent-sky-400">Terms &amp; Conditions</div>
          <p className="mb-3 text-sm text-muted-500">Scroll to the bottom to enable the checkbox below.</p>
        ...
        <section className="mb-8 rounded-2xl border border-border bg-panel p-6">
          <div className="mb-1 text-base font-bold uppercase tracking-widest text-accent-sky-400">Privacy Policy</div>
          <p className="mb-3 text-sm text-muted-500">Scroll to the bottom to enable the checkbox below.</p>
